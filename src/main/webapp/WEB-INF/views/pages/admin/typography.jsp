<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h4 class="title">The New Wavess</h4>
                <p class="category">Created using <a href="https://www.google.com/fonts/specimen/Muli">Muli</a> Font Family</p>
            </div>
            <div class="content">

                <div class="typo-line">
                    <h1><p class="category">Header 1</p>The New Waves </h1>
                </div>

                <div class="typo-line">
                    <h2><p class="category">Header 2</p>The New Waves </h2>
                </div>
                <div class="typo-line">
                    <h3><p class="category">Header 3</p>The New Waves </h3>
                </div>
                <div class="typo-line">
                    <h4><p class="category">Header 4</p>The New Waves </h4>
                </div>
                <div class="typo-line">
                    <h5><p class="category">Header 5</p>The New Waves </h5>
                </div>
                <div class="typo-line">
                    <h6><p class="category">Header 6</p>The New Waves </h6>
                </div>
                <div class="typo-line">
