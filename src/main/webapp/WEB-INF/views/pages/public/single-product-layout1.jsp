                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade" id="related5">
                                            <a href="#" class="zoom ex1"><img alt="single" src="<%=AppConfig.PUBLIC_RESOURCERS_PATH%>/img/product/single-product5.jpg" class="img-responsive"></a>
                                        </div>
                                        <div class="tab-pane fade" id="related6">
                                            <a href="#" class="zoom ex1"><img alt="single" src="<%=AppConfig.PUBLIC_RESOURCERS_PATH%>/img/product/single-product6.jpg" class="img-responsive"></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <ul class="tab-nav-inline cp-carousel nav-control-middle" data-loop="true" data-items="6" data-margin="15" data-autoplay="true" data-autoplay-timeout="5000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-r-x-small="2" data-r-x-small-nav="true" data-r-x-small-dots="false" data-r-x-medium="4" data-r-x-medium-nav="true" data-r-x-medium-dots="false" data-r-small="3" data-r-small-nav="true" data-r-small-dots="false" data-r-medium="4" data-r-medium-nav="true" data-r-medium-dots="false" data-r-Large="6" data-r-Large-nav="true" data-r-Large-dots="false">
                                        <li class="active">
                                        ...
                                        <li>
                                            <a href="#related5" data-toggle="tab" aria-expanded="false"><img alt="related5" src="<%=AppConfig.PUBLIC_RESOURCERS_PATH%>/img/product/single-product5.jpg" class="img-responsive"></a>
                                        </li>
                                        <li>
                                            <a href="#related6" data-toggle="tab" aria-expanded="false"><img alt="related6" src="<%=AppConfig.PUBLIC_RESOURCERS_PATH%>/img/product/single-product6.jpg" class="img-responsive"></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
