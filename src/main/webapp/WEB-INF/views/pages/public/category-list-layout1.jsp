                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                <div class="layout-switcher">
                                    <ul>
                                        ...
                                        <li><a class="product-view-trigger" href="#" data-type="category-grid-layout1"><i class="fa fa-th-large"></i></a></li>
                                        <li class="active"><a href="#" data-type="category-list-layout1" class="product-view-trigger"><i class="fa fa-list"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="category-view" class="category-list-layout1 gradient-padding zoom-gallery">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                <div class="product-box item-mb zoom-gallery">
                                    <div class="item-mask-wrapper">
                                        <div class="item-mask secondary-bg-box"><img src="<%=AppConfig.PUBLIC_RESOURCERS_PATH%>/img/product/product7.png" alt="categories" class="img-responsive">
                                            <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                            <div class="title-ctg">Clothing</div>
                                            <ul class="info-link">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                <div class="product-box item-mb zoom-gallery">
                                    <div class="item-mask-wrapper">
                                        <div class="item-mask secondary-bg-box"><img src="<%=AppConfig.PUBLIC_RESOURCERS_PATH%>/img/product/product8.png" alt="categories" class="img-responsive">
                                            <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                            <div class="title-ctg">Clothing</div>
                                            <ul class="info-link">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                <div class="product-box item-mb zoom-gallery">
                                    <div class="item-mask-wrapper">
                                        <div class="item-mask secondary-bg-box"><img src="<%=AppConfig.PUBLIC_RESOURCERS_PATH%>/img/product/product9.png" alt="categories" class="img-responsive">
                                            <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                            <div class="title-ctg">Clothing</div>
                                            <ul class="info-link">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                <div class="product-box item-mb zoom-gallery">
                                    <div class="item-mask-wrapper">
                                        <div class="item-mask secondary-bg-box"><img src="<%=AppConfig.PUBLIC_RESOURCERS_PATH%>/img/product/product10.png" alt="categories" class="img-responsive">
                                            <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                            <div class="title-ctg">Clothing</div>
                                            <ul class="info-link">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                <div class="product-box item-mb zoom-gallery">
                                    <div class="item-mask-wrapper">
                                        <div class="item-mask secondary-bg-box"><img src="<%=AppConfig.PUBLIC_RESOURCERS_PATH%>/img/product/product11.png" alt="categories" class="img-responsive">
                                            <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                            <div class="title-ctg">Electronics</div>
                                            <ul class="info-link">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                <div class="product-box item-mb zoom-gallery">
                                    <div class="item-mask-wrapper">
                                        <div class="item-mask secondary-bg-box"><img src="<%=AppConfig.PUBLIC_RESOURCERS_PATH%>/img/product/product12.png" alt="categories" class="img-responsive">
                                            <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                            <div class="title-ctg">Electronics</div>
                                            <ul class="info-link">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                <div class="product-box item-mb zoom-gallery">
                                    <div class="item-mask-wrapper">
                                        <div class="item-mask secondary-bg-box"><img src="<%=AppConfig.PUBLIC_RESOURCERS_PATH%>/img/product/product13.png" alt="categories" class="img-responsive">
                                            <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                            <div class="title-ctg">Clothing</div>
                                            <ul class="info-link">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                <div class="product-box item-mb zoom-gallery">
                                    <div class="item-mask-wrapper">
                                        <div class="item-mask secondary-bg-box"><img src="<%=AppConfig.PUBLIC_RESOURCERS_PATH%>/img/product/product14.png" alt="categories" class="img-responsive">
                                            <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                            <div class="title-ctg">Clothing</div>
                                            <ul class="info-link">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                <div class="product-box item-mb zoom-gallery">
                                    <div class="item-mask-wrapper">
                                        <div class="item-mask secondary-bg-box"><img src="<%=AppConfig.PUBLIC_RESOURCERS_PATH%>/img/product/product16.png" alt="categories" class="img-responsive">
                                            <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                            <div class="title-ctg">Clothing</div>
                                            <ul class="info-link">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                <div class="product-box item-mb zoom-gallery">
                                    <div class="item-mask-wrapper">
                                        <div class="item-mask secondary-bg-box"><img src="<%=AppConfig.PUBLIC_RESOURCERS_PATH%>/img/product/product17.png" alt="categories" class="img-responsive">
                                            <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                            <div class="title-ctg">Clothing</div>
                                            <ul class="info-link">
