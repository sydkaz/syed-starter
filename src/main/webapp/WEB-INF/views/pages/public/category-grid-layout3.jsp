            ...
            <div class="col-lg-push-3 col-md-push-4 col-sm-push-4 col-lg-9 col-md-8 col-sm-8 col-xs-12">
                <div class="gradient-wrapper item-mb">
                    ...
                    <div id="category-view" class="category-grid-layout3 gradient-padding zoom-gallery">
                        <div class="row">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-mb-12">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-mb-12">
                                <div class="product-box item-mb zoom-gallery">
                                    ...
                                    <div class="item-content">
                                        <div class="title-ctg">Clothing</div>
                                        <h3 class="short-title"><a href="http://www.radiustheme.com/demo/html/classipost/classipost/single-product1.html">Headset</a></h3>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-mb-12">
                                <div class="product-box item-mb zoom-gallery">
                                    ...
                                    <div class="item-content">
                                        <div class="title-ctg">Clothing</div>
                                        <h3 class="short-title"><a href="http://www.radiustheme.com/demo/html/classipost/classipost/single-product3.html">LED Monitor</a></h3>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-mb-12">
                                <div class="product-box item-mb zoom-gallery">
                                    ...
                                    <div class="item-content">
                                        <div class="title-ctg">Clothing</div>
                                        <h3 class="short-title"><a href="http://www.radiustheme.com/demo/html/classipost/classipost/single-product1.html">Duck Dog</a></h3>
